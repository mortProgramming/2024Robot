...
public class Drivetrain extends SubsystemBase {
	...
	public void zeroGyroscope(double robotvsFieldangle) {
		fieldOrientationOffset = robotvsFieldangle;
	}
	/*
	 * Converts negative and >2pi angles to circular angles. 361 -> 1 and -50 -> 50
	 */
